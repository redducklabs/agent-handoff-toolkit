...
- A prompt whose first line is `Continue from handoff: <path>` resumes that
  record's tracked chain, and the rest of the prompt is the work.
  `AHK-RESUME-FAILED` means it did not resume; tell the user.
